...
echo "==> confirm manifest on raw + purge the loader file"
for f in dist/loader/*.json; do
  ...
  for try in 1 2 3 4; do
    ...
    live=$(curl -sL --max-time 60 "https://raw.githubusercontent.com/$REPO/main/dist/loader/$name.json" | grep -oE "widget@[0-9a-f]{7,40}" | head -1 | sed "s/widget@//")
